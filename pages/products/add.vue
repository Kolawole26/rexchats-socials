<template>
  <section class="flex flex-col gap-8">
    <div class="flex items-center gap-2">
      <NuxtLink to="/products" class="body-small text-neutral-secondary hover:underline">
        Products
      </NuxtLink>
      <BaseCustomIcon name="chevron-down" customClass="w-4 h-4 text-neutral-secondary -rotate-90" />
      <p class="body-small text-neutral-primary font-semibold">Add Product</p>
    </div>
    ...
    <div class="max-w-[720px] mx-auto w-full">
      <div class="relative flex items-start justify-between gap-4">
        ...
        <div
          class="absolute left-0 top-5 h-[2px] bg-primary-100"
        ...
        <div
          ...
          :key="step.key"
          class="relative z-10 flex flex-col items-center gap-2 w-full"
        >
          <span
